...
- [ ] Project builds (e.g. `cmake -B build/static` and `cmake --build build/static`, or platform script with `-l static`).
- [ ] Tests pass (e.g. `ctest --test-dir build/static` or script `-a test`).
